...
def main() -> int:
    ...
    for pattern in ("test_phase_b.py", "test_appliance_candidate.py", "test_integrations.py", "test_package_firmware.py", "test_context_store.py", "test_appliance_setup.py"):
