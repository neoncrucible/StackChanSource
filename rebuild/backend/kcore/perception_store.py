...
class PerceptionStore:
    ...
    def _event(self, db, run, kind, trigger, *, session=None, person=None, frame=None, evidence=None):
        ...
        if kind not in {"occupancy", "subject_seen", "identity_confirmed", "subject_ended", "capture_failed", "recognition_unavailable"}: raise ValueError("Unsupported perception event.")
