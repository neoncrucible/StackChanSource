...
def camera_plan(text):
    ...
    phrases = {
        ...
        "unitv2": {"use the unitv2 camera","use the unit v2 camera","use the unit v two camera","use the extra camera"},
        "robot": {"use the robot camera","use the stackchan camera","use the built in camera"},
